...
def ad_libs_game():
    ...
    print("Today we are doing to play a game where you are going to input 22 words and see what crazy prompt you come up with!")
    ...
    print("\nIt was a "+adjective1+" day in the computer lab.", "A new programmer, named "+name1+" was trying to make "+noun1+ " move across the screen.", "They had to write a "+adjective2+" program to make it happen.")
    print("\nFirst, they typed in some "+plural_noun1+", which are like the rules for the computer. They need to tell the computer to "+verb1+ " colorful "+noun2+ " and then to "+verb2+ " it to a new spot.")
    print("\nBut the program had a "+adjective3+ " mistake, called a bug! The "+noun3+ " didn't move. Instead, it just started to " +verb2+ " and made a " +adjective4+" noise. The programmer was so "+adjective5+ "!")
    print("\nThey looked at their code again and found a small mistake. They had told the computer to go " +adverb1+ " instead of " +adverb2+ ". They fixed the bug, and this time, the " +noun4+ " started to " +verb3+ " across the screen, " +adverb3+ " and " +adverb4+ ".")
    print("\nEveryone cheered! The programmer had finally made the " +noun5+ " work. They were so happy, they decided to make it " +verb4+ " and sing a " +adjective6+ " song. It was a funny and " +adjective7+ " end to a long day of coding.")
    main()
def estimate_game():
    print("Lets see how much money this programmer might make if he sold his program to 100 companies!")
    program_cost = float(input("How much money do you think this program is worth?: "))
    ...
    print("This is how much he made if he gave half his money away to charity: $", format(float(half_gone), ".2f"),sep="")
def secret_number_game(max_guess):
    secret_number = random.randint(1, 20)
    guesses_left = max_guess
    print("Welcome to the secret number game!")
    print("Try to guess the secret number between 1 and 20! You have " + str(guesses_left) + " guesses left.")
    for attempts in range(guesses_left):
        ...
        print(f"\nSorry, you are out of guesses! The secret number was {secret_number}.")
        main()
